...
export default function SearchingPage() {
  ...
  // Blocks duplicate starts before React finishes updating state.
  ...
  useEffect(() => {
    ...
    if (savedState) {
      ...
      const generatedArray = randArr(DEFAULT_SIZE);
  ...
  const generate = useCallback(() => {
    ...
    const generatedArray = randArr(size);
