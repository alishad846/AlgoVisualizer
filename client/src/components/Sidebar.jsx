  ...
  return (
    <div className="av-nav-item">
      <button
        ...
        style={{ color: isActiveCat ? "var(--primary)" : undefined }}
      >
        <span className="av-nav-left">
          <span className="av-nav-icon">
            <Icon>{section.icon}</Icon>
          </span>
          <span style={{ fontWeight: isActiveCat ? 700 : 500 }}>
            {section.title}
          </span>
        </span>
        <Icon className={`av-chevron ${isOpen ? "av-rotate" : ""}`}>
          chevron_right
        </Icon>
      </button>
...
export default function Sidebar({ sidebarOpen = true }) {
  ...
  return (
    <aside
      className={`av-sidebar ${sidebarOpen ? "" : "av-sidebar-collapsed"}`}
    >
        ...
        <div className="av-sidebar-main">
          ...
          <nav className="av-nav">
            ...
            <Link
              ...
              style={{
                color:
                  location.pathname === "/visualize-my-code"
                    ? "var(--primary)"
                    : undefined,
                fontWeight:
                  location.pathname === "/visualize-my-code" ? 700 : 400,
                textDecoration: "none",
                display: "flex",
                alignItems: "center",
                gap: "10px",
